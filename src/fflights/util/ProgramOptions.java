 ...
 *     - Command line option values are valid
 *     - The options are within the correct bounds
 */
...
public class ProgramOptions {
    ...
    private String  reactions_val;      // TODO: Maybe this should be an ENUM type with values POSITIVE, NEGATIVE
    ...
    public static void main(String[] args) {
        ...
        //  TODO: Make sure you set the dev_path to wherever you have the source code!
        String dev_path  = home_path + "/git";
        String data_path = dev_path + "/find-flights/data/";
        String[] testargs = new String[]{
                ...
                "--min-miles",     "200",
                "--max-miles",     "5000",
                "--max-meters",    "80000",   // Approximately 50 miles
                "--min-rating",    "3.5",
                "--min-reviews",   "20",
                "--min-cost",      "2",
                "--max-cost",      "3" };
